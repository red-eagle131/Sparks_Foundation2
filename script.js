 ...
 var enterSName = document.getElementById("enterSName").value;
  var findSenderBankAccount = enterSName + "BankBalance";
    ...
    if (enterAmount > enterSAmount) {
       alert("Your Balance is Insufficient for Successful Transaction")
    }
 else {
       ...
       $${enterAmount} is sent to ${enterName} with email-Id ${enterName}@email.com.`)
 
       // transaction history 
       var createPTag = document.createElement("li");
       var textNode = document.createTextNode(`${enterName}@email.com received Rs ${enterAmount} from ${enterSName}@email.com on ${Date()}.`);
